...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="top-0 left-2 z-10 flex h-[2.5rem] items-center justify-center lg:mt-10">
      ...
      />
      <nav
        className={`absolute z-5 flex-col justify-between bg-white lg:static lg:flex lg:translate-x-0 lg:flex-row dark:bg-black ${hiddenNavigation ? 'translate-x-full' : 'translate-x-0'} mb-4 -ml-2 w-full pl-2 text-[1.3rem] font-medium duration-300 lg:ml-0 lg:pl-0 ${hiddenHeader ? 'translate-x-full' : 'translate-x-0'} mt-6`}
      >
        <div className="block gap-24 lg:mx-auto lg:flex lg:text-[2rem]">
