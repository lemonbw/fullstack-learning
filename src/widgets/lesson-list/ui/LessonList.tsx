...
export default function LessonList() {
  ...
  return (
    <section className="z-10 mx-auto mt-4 w-[80vw]">
      <LessonSortButton isAsc={isAsc} onSortClick={handleSortChange} />

      <div className="mt-4 overflow-hidden rounded-xl border-2 bg-white lg:mt-6 dark:bg-black">
        <SearchInput
          query={query}
          setQuery={setQuery}
          className="mt-4 mb-2 h-5 w-30 rounded border-2 text-center text-[0.7rem] lg:h-8 lg:w-80 lg:text-[1.1rem]"
          placeholder="Lesson, title, date"
        />
